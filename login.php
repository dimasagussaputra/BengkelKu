...
<body style="background: url('foto/background.jpg') no-repeat center center fixed; background-size: cover;">
	<section id="main-wrapper" style="margin-top: 200px">
		<div class="container-fluid">
			...
			<div class="row">
				<div id="page-wrapper" class="col-lg-4 col-lg-offset-4 col-md-4 col-md-offset-4" style="background-color:rgb(255, 255, 255); border-radius: 15px;">
					<div class="row">
						<div class="col-lg-12">
							<br/>
							...
							<div class="panel panel-default">
								<div class="panel-body">
									<form action="login_auth.php" method="post">
										...
										<div class="form-group">
											<input type="submit" style="font-weight: 600;" class="btn btn-warning btn-block" name="login" value="Masuk">
										</div>
										<h2 class="text-center" style="font-size: 12px; font-family: Roboto; font-weight: 400;">Belum punya akun? <a href="register.php" style="color:blue"> Daftar</a></h2>
									</form>
								</div>
							</div>
						</div>
